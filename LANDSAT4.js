...
for(var x = 0; x<Size_of_Collection; x++)
{
  ...
  if(exporting === true)
  {
    Export.image.toDrive({
      ...
      description: 'LANDSAT4_' + name_of_Sat_Image,
      folder: folderName,
      scale: exportScale,
      region : AOI,
      skipEmptyTiles : true
    ...
    Export.image.toDrive({
      ...
      description: 'LANDSAT4_' + name_of_Cloud_Masked_Image,
      folder: folderName,
      scale: exportScale,
      region : AOI,
      skipEmptyTiles : true
    ...
    Export.image.toDrive({
      ...
      description: 'LANDSAT4_' + name_of_NDWI_Image,
      folder: folderName,
      scale: exportScale,
      region : AOI,
      skipEmptyTiles : true
    ...
    Export.image.toDrive({
      ...
      description: 'LANDSAT4_' + name_of_NDWI_Without_CloudMask_Image,
      folder: folderName,
      scale: exportScale,
      region : AOI,
      skipEmptyTiles : true
