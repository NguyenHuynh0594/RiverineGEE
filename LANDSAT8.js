...
//Discription: Cloud Masking and Compute MNDWI around Mission River near Refugio, Texas using USGS Landsat 8 TOA Reflectance (Orthorectified) with Fmask.
//--------------------------------------------------------------------------
*/
...
//Dates of interest Apr 11, 2013 - Oct 21, 2017
...
var Riverine = ee.ImageCollection('LANDSAT/LC8_L1T_TOA_FMASK')
.filterBounds(river)
...
var vizParams = {bands: ['B4', 'B3', 'B2'], min: 0, max: 0.5,gamma: [0.95, 1.1, 1]};
