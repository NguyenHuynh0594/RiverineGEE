...
//Discription: Cloud Masking and Compute MNDWI around Mission River near Refugio, Texas using USGS Landsat 5 TOA Reflectance (Orthorectified) with Fmask. 
//--------------------------------------------------------------------------
*/
...
//Dates of interest Jan 1, 1984 - May 5, 2012
/*
var Start = ee.Date('1984-1-01');
var End = ee.Date('2012-5-5');
*/
var Start = ee.Date('2002-7-01');
var End = ee.Date('2003-3-31');

//Create image collection
var Riverine = ee.ImageCollection('LANDSAT/LT5_L1T_TOA_FMASK')
.filterBounds(river)
...
for(var x = 0; x<Size_of_Collection; x++)
{
  ...
  if(exporting === true)
  {
    Export.image.toDrive({
      ...
      description: 'LANDSAT5_' + name_of_Sat_Image,
      folder: folderName,
      scale: exportScale,
      region : AOI,
      skipEmptyTiles : true
    ...
    Export.image.toDrive({
      ...
      description: 'LANDSAT5_' + name_of_Cloud_Masked_Image,
      folder: folderName,
      scale: exportScale,
      region : AOI,
      skipEmptyTiles : true
    ...
    Export.image.toDrive({
      ...
      description: 'LANDSAT5_' + name_of_NDWI_Image,
      folder: folderName,
      scale: exportScale,
      region : AOI,
      skipEmptyTiles : true
    ...
    Export.image.toDrive({
      ...
      description: 'LANDSAT5_' + name_of_NDWI_Without_CloudMask_Image,
      folder: folderName,
      scale: exportScale,
      region : AOI,
      skipEmptyTiles : true
